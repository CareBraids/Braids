  ...
  return (
    <div className="relative h-screen w-full overflow-hidden bg-[#fdf4ff]">
      ...
      <div className="absolute inset-0">
        ...
        {/* Mobile: Gradient from bottom up for readability - Softened at top */}
        <div className="absolute inset-0 bg-gradient-to-t from-[#fae8ff]/95 via-[#fae8ff]/10 to-transparent h-full md:hidden" />

        {/* Desktop: A soft white gradient from the left */}
        ...
        <div className="absolute bottom-0 w-full h-[35%] md:h-[35%] bg-gradient-to-t from-[#fff5f7] via-[#fff5f7]/10 to-transparent" />
      </div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto h-full flex flex-col justify-end md:justify-center px-6 md:px-12 pb-48 md:pb-0 pt-20">
        <div className="max-w-2xl text-left">
          ...
          <motion.h1
            className="text-[2.8rem] sm:text-[3.5rem] md:text-6xl lg:text-[5.5rem] font-medium tracking-tight mb-4 md:mb-6 font-serif text-[#fa3ac2] md:text-[#fa3ac2] leading-[1.05] sm:leading-[1.05]"
          ...
          <motion.p
            className="max-w-xl text-[1.2rem] md:text-xl font-medium md:font-normal tracking-wide mb-6 md:mb-8 text-[#5a2a3f]"
          ...
          <motion.div
            className="inline-flex items-center gap-3 px-4 py-2.5 md:px-5 md:py-3 rounded-2xl bg-gradient-to-br from-white/90 to-white/50 md:from-white/70 md:to-white/30 backdrop-blur-xl border border-white/80 shadow-[0_8px_32px_0_rgba(96,20,56,0.15)] mb-6 md:mb-10 w-auto group cursor-default"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          <motion.div
            className="flex flex-row gap-3 sm:gap-4 w-full sm:w-auto mt-2 md:mt-6"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
